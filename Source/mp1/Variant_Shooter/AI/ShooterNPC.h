 ...
 */
UCLASS(abstract)
class MP1_API AShooterNPC : public Amp1Character, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<class AShootWeapon> Weapon;

	/** Type of weapon to spawn for this character */
	UPROPERTY(EditAnywhere, Category="Weapon")
	TSubclassOf<class AShootWeapon> WeaponClass;
...
public:
	...
	void DoFireAction(AActor* ActorToShoot);
